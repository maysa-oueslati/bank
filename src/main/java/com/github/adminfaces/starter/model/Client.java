...
public class Client extends User implements Serializable {
	...
	public Client(String phnb, String cin, String adress, String first_name, String last_name, Date date_of_birth) {
		super();
		this.phnb = phnb;
		this.cin = cin;
		this.adress = adress;
	...
	public Client(String username, String email, String password, String cin, String adress, String first_name,
			String last_name, Date date_of_birth,String phnb) {
		super(username, email, password);
		this.cin = cin;
		this.adress = adress;
		this.first_name = first_name;
	...
	public Client(long id ,String username, String email, String password, String cin, String adress, String first_name,
			String last_name, Date date_of_birth,String phnb) {
	...
	public void setLast_name(String last_name) {
	 ...
	 public boolean hasCin() {
	        return cin != null && !"".equals(cin.trim());
	    }

	    public boolean hasGroupe() {
	        return groupe != null && !"".equals(groupe.trim());
	    }
